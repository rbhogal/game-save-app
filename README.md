...
* Other than Bennett Wong's loading dots from [CodePen](https://codepen.io/bennett/pen/GjRPdk) and the [React Slick Library](https://react-slick.neostack.com/) for Carousels (although I did alter some code to customize) all of the code was written by me 
